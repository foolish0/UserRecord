						...
						<ul class="pf-user-opt">
							...
							<li class="pf-modify-pwd">
								<a href="#" onclick="goToMessage()">
									<i class="iconfont">&#xe6f8;</i>
									<span class="pf-opt-name">消息<i class="mailtext ">[<span class="unreadMsgNum">${unreadMsgNum }</span>]</i></span>
								</a>
							</li>
							<li class="pf-modify-pwd">
						...
						<table class="kv-table">
							<tbody>
								<tr>
									...
									<td class="kv-content"><input name="password" type="password"easyui-validatebox" data-options="required:true" /></td>
								</tr>
								<tr>
									<td class="kv-label">新密码</td>
									<td class="kv-content">
										<input type="password" name="newPassword" class="easyui-validatebox" data-options="required:true" />
									</td>
								</tr>
								<tr>
									<td class="kv-label">确认密码</td>
									<td class="kv-content">
										<input type="password" name="newPasswordConfirm" class="easyui-validatebox" data-options="required:true" />
									</td>
								</tr>
								<tr>
									<td colspan="4" style="    text-align: center;    padding-top: 20px;"><a href="#" class="easyui-linkbutton"
										 iconCls="icon-ok" data-options="" onclick="postPwd()">提交</a></td>
								</tr>
							</tbody>
						</table>
					</form>
