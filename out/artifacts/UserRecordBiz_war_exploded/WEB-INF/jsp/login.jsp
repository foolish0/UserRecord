						...
						<div class="lg-box">
							...
							<form id="nameloginForm">
								...
								<div class="lg-check clearfix">
									...
									<img class="check-code" id="checkCode"  alt="验证码" src="/Login/checkCode.dhtml" onclick="changeValidateCode()" style="cursor:pointer;"/>
								</div>
								<div class="tips clearfix">
									<!-- <label><input type="checkbox" checked="checked">记住用户名</label> -->
									<a href="javascript:;" class="register" style="float: left;margin-left: 40px;" onclick="changeForm('phone')">手机号登录</a>
							...
							<form id="phoneloginForm" style="display:none">
								...
								<div class="lg-check clearfix">
									...
									<span class="check-code" style="cursor:pointer" onclick="getPhoneValidCode(this,'phone_phone')">获取验证码</span>
								</div>
								<div class="tips clearfix">
									<a href="javascript:;" class="register" style="float: left;margin-left: 40px;" onclick="changeForm('name')">账号密码登录</a>
									<!-- <a href="javascript:;" class="register">立即注册</a> -->
								</div>
								<div class="enter">
							...
							<form id="pwdForm" style="display:none">
								...
								<div class="lg-check clearfix">
									...
									<span class="check-code" style="cursor:pointer" onclick="getPhoneValidCode(this,'pwd_phone')">获取验证码</span>
								</div>
